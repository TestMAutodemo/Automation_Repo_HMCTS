...
export declare class PendingAsyncCollection<T> {
    ...
    any(callback: (value: T, index: number, items: T[]) => unknown): Promise<boolean>;
    /**
    ...
    every(predicate: (value: T, index: number, items: T[]) => unknown): Promise<boolean>;
    /**
    ...
    find(predicate: (value: T, index: number, items: T[]) => Promise<unknown>): Promise<T | undefined>;
    find(predicate: (value: T, index: number, items: T[]) => unknown): Promise<T | undefined>;
    /**
    ...
    first<S extends T>(predicate?: (value: T, index: number, items: T[]) => value is S): Promise<T | undefined>;
    first(predicate?: (value: T, index: number, items: T[]) => Promise<unknown>): Promise<T | undefined>;
    first(predicate?: (value: T, index: number, items: T[]) => unknown): Promise<T | undefined>;
    /**
     ...
     * @param {Function} callback
     */
    forEach(callback: (value: T, index: number, items: T[]) => Promise<any> | any): Promise<void>;
    /**
     ...
     * @returns {Boolean}
     */
    has(callback: (value: T, index: number, items: T[]) => Promise<boolean> | boolean): Promise<boolean>;
    /**
     ...
     * @returns {Boolean}
     */
    includes(callback: (value: T, index: number, items: T[]) => Promise<boolean> | boolean): Promise<boolean>;
    /**
    ...
    last<S extends T>(predicate?: (value: T, index: number, items: T[]) => value is S): Promise<T | undefined>;
    last(predicate?: (value: T, index: number, items: T[]) => Promise<unknown>): Promise<T | undefined>;
    last(predicate?: (value: T, index: number, items: T[]) => unknown): Promise<T | undefined>;
    /**
    ...
    reduce<R>(reducer: (carry: R, currentValue: T, currentIndex?: number, items?: T[]) => R, accumulator: R): Promise<R>;
    /**
    ...
    reduceRight<R>(reducer: (carry: R, currentValue: T, currentIndex?: number, items?: T[]) => R, accumulator: R): Promise<R>;
    /**
    ...
    */
     ...
     * @returns {Boolean}
     */
    some(callback: (value: T, index: number, items: T[]) => Promise<unknown>): Promise<boolean>;
    some(callback: (value: T, index: number, items: T[]) => unknown): Promise<boolean>;
    /**
