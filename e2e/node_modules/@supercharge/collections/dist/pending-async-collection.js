...
class PendingAsyncCollection {
     ...
     */
    clone() {
        return new PendingAsyncCollection(this.items.slice(), this.callChain.items());
    }
    /**
    ...
    async every(callback) {
        return this.enqueue('every', callback).all();
    }
    filter(predicate) {
    ...
    async forEach(callback) {
        return await this.enqueue('forEach', callback).all();
    }
    /**
     ...
     */
    async has(callback) {
        return this.enqueue('has', callback).all();
    }
    /**
     ...
     */
    async hasDuplicates() {
        return this.enqueue('hasDuplicates').all();
    }
    /**
     * Determines whether the the collection contains the item
     * represented by `callback` or if the collection
     ...
     */
    async isEmpty() {
        return this.enqueue('isEmpty').all();
    }
    /**
     ...
     */
    async isNotEmpty() {
        return this.enqueue('isNotEmpty').all();
    }
    /**
     ...
     */
    map(action) {
        return this.enqueue('map', action);
    }
    /**
     ...
     */
    async median() {
        return this.enqueue('median').all();
    }
    /**
