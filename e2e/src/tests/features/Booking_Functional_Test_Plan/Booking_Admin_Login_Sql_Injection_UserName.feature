Feature: Admin Login:Application rejects SQL injection attempts on UserName datafield
Background: 
Given user is on the "home" page
@smoke
Scenario Outline:  SQL injection protection Username datafield
And user clicks the "Adminlink" button, on the "Admin" page
And user is directed to the "admin" page
Then user types "<PayloadUserName>" into "AdminUser" input, on the "Login" page
Then user types "anypassowrd!" into "AdminPassword" input, on the "Login" page
